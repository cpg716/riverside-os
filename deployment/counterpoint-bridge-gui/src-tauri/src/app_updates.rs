...
const APP_UPDATER_ENDPOINT: Option<&str> = option_env!("RIVERSIDE_COUNTERSYNC_UPDATER_ENDPOINT");
const APP_UPDATER_PUBLIC_KEY: Option<&str> =
    option_env!("RIVERSIDE_COUNTERSYNC_UPDATER_PUBLIC_KEY");
const BUILD_SHA: Option<&str> = option_env!("RIVERSIDE_BUILD_SHA");
const GITHUB_SHA: Option<&str> = option_env!("GITHUB_SHA");
const APP_ENDPOINT_ENV: &str = "RIVERSIDE_COUNTERSYNC_UPDATER_ENDPOINT";
const APP_PUBLIC_KEY_ENV: &str = "RIVERSIDE_COUNTERSYNC_UPDATER_PUBLIC_KEY";
