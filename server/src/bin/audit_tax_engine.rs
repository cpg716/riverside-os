use riverside_server::logic::tax::{nys_erie_total_sales_tax_usd, TaxCategory};
...
fn main() {
    ...
    println!("Clothing $95.00 -> Tax: ${tax_under} (Expected: ${expected_under})");
    ...
    println!("Clothing $110.00 -> Tax: ${tax_exact} (Expected: ${expected_exact})");
    ...
    println!("Clothing $150.00 -> Tax: ${tax_over} (Expected: ${expected_over})");
    ...
    println!("Accessory $50.00 -> Tax: ${tax_other} (Expected: ${expected_other})");
