...
//! the vendor **raw** unit cost on `inventory_transactions`; any freight allocation carried in
//! the legacy `landed_cost_component` field must stay separate from item cost.
