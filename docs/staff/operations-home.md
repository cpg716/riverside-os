...
5. An incoming **Unknown sender** can be answered without creating or matching a customer. Match/add only after staff can verify identity. When starting a separate **New message** to a new number, first and last name are still required and ROS creates the contact.
