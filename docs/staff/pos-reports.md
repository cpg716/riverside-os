...
6. **Review or Print Audit**: Tap **View** to open the professional full-page Daily Sales document inside ROS, or **Print** to send it to the configured Reports printer.
