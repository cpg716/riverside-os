# Orders and stock (staff abstract)

**Full detail:** [../../../INVENTORY_GUIDE.md](../../../INVENTORY_GUIDE.md), [../../../AGENTS.md](../../../AGENTS.md) (order model).

---

## What staff should remember

1. **Checkout** does **not** reduce **stock_on_hand** the same way for **order** (and similar) lines as for immediate **pickup** of in-stock goods.
2. **Receiving** can increase **on_hand** and may **reserve** quantity toward open order demand.
...
- Do not promise **same-day pickup** for an **order** unless the line and notes confirm it.
