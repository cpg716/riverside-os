...
6. **Edit profile:** Open **Edit** on a person to modify **name**, **role**, active flag, **commission %**, **discount caps**, **linked CRM profile**, **avatar icon**, etc. Staff may also upload a **real photo** from their own Profile page; photos take precedence over icons everywhere avatars appear.
