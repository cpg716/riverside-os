...
6. **Edit profile:** Open **Edit** on a person to modify **name**, **role**, active flag, **commission %**, **discount caps**, **linked CRM profile**, **avatar icon**, etc. Staff may also upload a **real photo** or generate an **AI Avatar** (using prompt-based diffusion from their Profile page); photos and generated avatars take precedence over icons everywhere avatars appear.
