...
3. **Post-import operational smoke test**
...
4. **Audit, rollback, and reconciliation proof**
...
5. **POS sale flow with Counterpoint-ingested items**
...
6. **Register close and drawer reconciliation**
...
7. **Register inventory and fulfillment impact**
...
8. **QBO staging from real register activity**
...
9. **QBO sync safety and reconciliation**
