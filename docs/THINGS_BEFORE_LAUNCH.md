...
**At launch, treat this as a status check—not a feature flip** unless product has explicitly shipped a new LLM layer. **ROSIE** (**RiversideOS Inventory Overview Engine**) is the planned in-app assistant name; it is **not** implied by shipping Help Center alone.
...
## Decision Support & Inventory Overview
