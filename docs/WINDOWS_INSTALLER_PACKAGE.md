...
```text
RiversideOS-v0.80.0-Windows-Deployment/
...
```powershell
.\deployment\windows\build-deployment-package.ps1 -Version "0.80.0"
```
...
Hotfix/support actions included in v0.80.0 packages:
