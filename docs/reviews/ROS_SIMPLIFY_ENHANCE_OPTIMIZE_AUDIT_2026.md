...
| P2 | Customer directory | The former customer-search placeholder used cryptic name shorthand. | Live rendered search. | Use plain searchable fields: name, phone, email, customer code, or company. |
