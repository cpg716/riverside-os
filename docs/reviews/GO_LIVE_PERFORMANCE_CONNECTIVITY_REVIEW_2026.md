...
| Register close | `CloseRegisterModal`, register reports | session close and register-day activity endpoints | Close is blocked while checkout recovery items exist, preventing unreviewed offline sales from being hidden by Z-close. |
