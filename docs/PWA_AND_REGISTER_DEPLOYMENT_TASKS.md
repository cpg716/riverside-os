...
- [ ] Latest `main` **Playwright E2E** must be green on the `v0.80.8` release commit before calling the current head release-ready. Use the release-certification evidence plus a fresh CI run after commit/push.
