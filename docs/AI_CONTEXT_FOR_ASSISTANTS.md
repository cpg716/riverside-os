...
| [`MANUAL_CREATION.md`](MANUAL_CREATION.md) + [`HELP_CENTER_AUTOMATION.md`](HELP_CENTER_AUTOMATION.md) | Shipped **Help Center**: **`GET /api/help/search`**, **`ros_help`**, manuals under `client/src/assets/docs/*-manual.md`. |
...
| **Live help retrieval (server)** | **`GET /api/help/search`**, [`MANUAL_CREATION.md`](MANUAL_CREATION.md), [`HELP_CENTER_AUTOMATION.md`](HELP_CENTER_AUTOMATION.md), [`ROS_AI_HELP_CORPUS.md`](ROS_AI_HELP_CORPUS.md) | Current: **`ros_help`** corpus, optional Meilisearch, generated from bundled in-app manuals. Retired **`/api/ai/*`** and **`ai_doc_chunk`** are not current. |
| **ROSIE (local assistant)** | [`PLAN_LOCAL_LLM_HELP.md`](PLAN_LOCAL_LLM_HELP.md), [`ROSIE_OPERATING_CONTRACT.md`](ROSIE_OPERATING_CONTRACT.md), [`ROS_AI_INTEGRATION_PLAN.md`](../ROS_AI_INTEGRATION_PLAN.md) | **ROSIE** = **RiversideOS Intelligence Engine**; Help Center chat and insight behavior must stay grounded in Help/manuals, Store SOP, and approved read tools (**no** ad-hoc SQL). |
...
| **ROSIE product and roadmap** | [`AI_INTEGRATION_OUTLOOK.md`](AI_INTEGRATION_OUTLOOK.md), [`ROS_AI_INTEGRATION_PLAN.md`](../ROS_AI_INTEGRATION_PLAN.md), [`PLAN_LOCAL_LLM_HELP.md`](PLAN_LOCAL_LLM_HELP.md) | Shipped ROSIE Help/chat/read-tool behavior, remaining roadmap, and safety boundaries. |
| **In-store ROSIE providers and sidecar** | [`PLAN_LOCAL_LLM_HELP.md`](PLAN_LOCAL_LLM_HELP.md), [`ROSIE_OPERATING_CONTRACT.md`](ROSIE_OPERATING_CONTRACT.md), [`ROSIE_HOST_STACK.md`](ROSIE_HOST_STACK.md) | Ask ROSIE and ROSIE Chat ship in the Help drawer. Availability still depends on the selected server-governed provider and workstation speech/runtime health; never claim a provider is healthy without current status. |
...
| **Help ingest / search ranking** | Chunking, generated manifest paths, Meilisearch settings, or reindex contract changes without operator docs | Update [`ROS_AI_HELP_CORPUS.md`](ROS_AI_HELP_CORPUS.md), [`HELP_CENTER_AUTOMATION.md`](HELP_CENTER_AUTOMATION.md), and [`MANUAL_CREATION.md`](MANUAL_CREATION.md) when `help_corpus.rs`, generated help outputs, or `/api/help/admin/ops/reindex-search` behavior changes. |
...
- **Chat transport (shipped):** Help first requests permission-filtered grounding from **`POST /api/help/rosie/v1/tool-context`**, then streams through staff-gated **`POST /api/help/rosie/v1/chat/completions`**. Provider selection is server-governed for local Gemma, Remote LM Studio, OpenAI, or Gemini; Tauri direct mode remains a configured local optimization, not an RBAC bypass — [`PLAN_LOCAL_LLM_HELP.md`](PLAN_LOCAL_LLM_HELP.md#ship-decision-parity-and-desktop-sidecar), **`DEVELOPER.md`** env table.
