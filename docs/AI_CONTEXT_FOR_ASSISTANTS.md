...
| **In-store LLM / sidecar “AI”** | [`PLAN_LOCAL_LLM_HELP.md`](PLAN_LOCAL_LLM_HELP.md), [`ROSIE_OPERATING_CONTRACT.md`](ROSIE_OPERATING_CONTRACT.md) | Verify the current build/routes before claiming a cashier-facing assistant exists. Do **not** tell staff an in-app LLM exists by default unless the shipped product explicitly exposes it. |
