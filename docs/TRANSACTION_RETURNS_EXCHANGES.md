...
1. **Queue sources**
   ...
   - Lines with vendor, purchase-order, ordered, received, or ready-for-pickup activity are blocked from the simple cancellation route. Resolve the procurement commitment first so customer, PO, receiving, inventory, and vendor records do not diverge.
