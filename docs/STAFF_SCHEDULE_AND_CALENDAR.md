...
This document describes published weekly schedules and day exceptions for schedule-eligible operational staff: **Admin**, **Salesperson**, **Sales Support**, **Staff Support**, and **Alterations**. It covers the PostgreSQL function that decides “working or not,” REST endpoints under **`/api/staff/schedule`**, and how the **Operations Morning Dashboard** surfaces **today’s floor team**.
