...
## Current Deployment Status (2026-05-22)

- [x] Target release version is **`v0.70.7`**.
- [ ] Current release tag exists: **`v0.70.7`**.
- [ ] Current release has Windows installer/updater assets published.
  - Required action: tag/publish `v0.70.7`, then run the Windows updater release workflow and Windows deployment package workflow before installing Windows stations.
  - Required artifacts: `latest.json`, `riverside-updater-build-manifest.json`, Windows MSI, matching `.sig`, and `RiversideOS-v0.70.7-Windows-Deployment.zip`.
- [ ] Current release has macOS Deployment Manager DMG published.
  - Required artifact: `RiversideOS-Deployment-Manager_0.70.7_universal.dmg`.
- [ ] Latest Playwright E2E push on `main` passed for the final `v0.70.7` release commit.
- [ ] Latest Lint Checks push on `main` passed for the final `v0.70.7` release commit.
...
## v0.70.7 Release Readiness Blockers

- [ ] `v0.70.7` Windows updater assets exist: `latest.json`, `riverside-updater-build-manifest.json`, MSI, and `.sig`.
- [ ] `v0.70.7` Windows deployment package exists and its manifest source SHA matches the release tag.
- [ ] `v0.70.7` macOS Deployment Manager DMG exists.
...
- [ ] v0.70.7 automated certification evidence is recorded in [`docs/releases/v0.70.7-certification.md`](releases/v0.70.7-certification.md).
