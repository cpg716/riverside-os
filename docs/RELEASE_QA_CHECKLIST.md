...
1. **Offline recovery** keeps blocked checkout replay rows visible and repairable, leaves ordinary authorized register close available, and preserves exact pre-close warnings in the audited close record without resolving them or printing them on the financial Z-Report.
