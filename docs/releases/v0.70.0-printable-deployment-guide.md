# Riverside OS v0.70.0 Printable Deployment Guide
...
```text
https://github.com/cpg716/riverside-os/releases/tag/v0.70.0
```

Required release assets:

- [ ] `RiversideOS-v0.70.0-bdb47f1b-Windows-Deployment.zip`
- [ ] `Riverside.POS_0.70.0_x64_en-US.msi`
- [ ] `Riverside.POS_0.70.0_x64_en-US.msi.sig`
- [ ] `latest.json`
...
```text
Version: 0.70.0
Release SHA: bdb47f1b
Deployment package: RiversideOS-v0.70.0-bdb47f1b-Windows-Deployment.zip
```
...
- [ ] Settings -> Updates shows Riverside `0.70.0`.
...
- [ ] Confirm Settings -> Updates shows `0.70.0`.
...
- [ ] Confirm server starts and Settings -> Updates shows `0.70.0`.
- [ ] Update Register #1 desktop app.
- [ ] Relaunch Register #1 and confirm Settings -> Updates shows `0.70.0`.
...
4. Do not continue production work until all surfaces show `0.70.0`.
