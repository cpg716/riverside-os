# Riverside OS v0.60.2 Printable Deployment Guide
...
```text
https://github.com/cpg716/riverside-os/releases/tag/v0.60.2
```

Required release assets:

- [ ] `RiversideOS-v0.60.2-349f1a90-Windows-Deployment.zip`
- [ ] `Riverside.POS_0.60.2_x64_en-US.msi`
- [ ] `Riverside.POS_0.60.2_x64_en-US.msi.sig`
- [ ] `latest.json`
...
```text
Version: 0.60.2
Release SHA: 349f1a904de18031df9c3a6660e36b47cd2d2c94
Deployment package: RiversideOS-v0.60.2-349f1a90-Windows-Deployment.zip
```
...
- [ ] Settings -> Updates shows Riverside `0.60.2`.
...
- [ ] Confirm Settings -> Updates shows `0.60.2`.
...
- [ ] Confirm server starts and Settings -> Updates shows `0.60.2`.
- [ ] Update Register #1 desktop app.
- [ ] Relaunch Register #1 and confirm Settings -> Updates shows `0.60.2`.
...
4. Do not continue production work until all surfaces show `0.60.2`.
