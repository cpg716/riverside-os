# Riverside OS v0.70.1 Printable Deployment Guide
...
```text
https://github.com/cpg716/riverside-os/releases/tag/v0.70.1
```

Required release assets:

- [ ] `RiversideOS-v0.70.1-Windows-Deployment.zip`
- [ ] `Riverside.POS_0.70.1_x64_en-US.msi`
- [ ] `Riverside.POS_0.70.1_x64_en-US.msi.sig`
- [ ] `latest.json`
...
```text
Version: 0.70.1
Deployment package: RiversideOS-v0.70.1-Windows-Deployment.zip
```
...
- [ ] Settings -> Updates shows Riverside `0.70.1`.
...
- [ ] Confirm Settings -> Updates shows `0.70.1`.
...
- [ ] Confirm server starts and Settings -> Updates shows `0.70.1`.
- [ ] Update Register #1 desktop app.
- [ ] Relaunch Register #1 and confirm Settings -> Updates shows `0.70.1`.
...
4. Do not continue production work until all surfaces show `0.70.1`.
