# Riverside OS v0.70.5 Printable Deployment Guide
...
```text
https://github.com/cpg716/riverside-os/releases/tag/v0.70.5
```

Required release assets:

- [ ] `RiversideOS-v0.70.5-Windows-Deployment.zip`
- [ ] `Riverside.POS_0.70.5_x64_en-US.msi`
- [ ] `Riverside.POS_0.70.5_x64_en-US.msi.sig`
- [ ] `latest.json`
- [ ] `riverside-updater-build-manifest.json`
- [ ] `RiversideOS-Deployment-Manager_0.70.5_universal.dmg` (macOS remote management)

Expected release identity:

```text
Version: 0.70.5
Deployment package: RiversideOS-v0.70.5-Windows-Deployment.zip
```
...
- [ ] Settings -> Updates shows Riverside `0.70.5`.
...
- [ ] Confirm Settings -> Updates shows `0.70.5`.
...
- [ ] Confirm server starts and Settings -> Updates shows `0.70.5`.
- [ ] Update Register #1 desktop app.
- [ ] Relaunch Register #1 and confirm Settings -> Updates shows `0.70.5`.
...
4. Do not continue production work until all surfaces show `0.70.5`.
