# Riverside OS v0.70.2 Printable Deployment Guide
...
```text
https://github.com/cpg716/riverside-os/releases/tag/v0.70.2
```

Required release assets:

- [ ] `RiversideOS-v0.70.2-Windows-Deployment.zip`
- [ ] `Riverside.POS_0.70.2_x64_en-US.msi`
- [ ] `Riverside.POS_0.70.2_x64_en-US.msi.sig`
- [ ] `latest.json`
...
```text
Version: 0.70.2
Deployment package: RiversideOS-v0.70.2-Windows-Deployment.zip
```
...
- [ ] Settings -> Updates shows Riverside `0.70.2`.
...
- [ ] Confirm Settings -> Updates shows `0.70.2`.
...
- [ ] Confirm server starts and Settings -> Updates shows `0.70.2`.
- [ ] Update Register #1 desktop app.
- [ ] Relaunch Register #1 and confirm Settings -> Updates shows `0.70.2`.
...
4. Do not continue production work until all surfaces show `0.70.2`.
...
1. Launch the app.
2. Enter the ROS server URL (e.g., `http://10.64.70.196:3000` or Tailscale address).
3. Enter your staff PIN.
4. Dashboard auto-refreshes every 30 seconds.

### Use Cases

- Remote DevOps monitoring via Tailscale
