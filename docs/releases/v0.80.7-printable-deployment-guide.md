# Riverside OS v0.80.7 Printable Deployment Guide
...
```text
https://github.com/cpg716/riverside-os/releases/tag/v0.80.7
```

Required release assets:

- [ ] `RiversideOS-v0.80.7-Windows-Deployment.zip`
- [ ] `Riverside.POS_0.80.7_x64_en-US.msi`
- [ ] `Riverside.POS_0.80.7_x64_en-US.msi.sig`
- [ ] `latest.json`
- [ ] `riverside-updater-build-manifest.json`
- [ ] `RiversideOS-Deployment-Manager_0.80.7_universal.dmg` (macOS remote management)

Expected release identity:

```text
Version: 0.80.7
Deployment package: RiversideOS-v0.80.7-Windows-Deployment.zip
```
...
- [ ] Settings -> Updates shows Riverside `0.80.7`.
...
- [ ] Confirm Settings -> Updates shows `0.80.7`.
...
- [ ] Confirm server starts and Settings -> Updates shows `0.80.7`.
- [ ] Update Register #1 desktop app.
- [ ] Relaunch Register #1 and confirm Settings -> Updates shows `0.80.7`.
...
4. Do not continue production work until all surfaces show `0.80.7`.
