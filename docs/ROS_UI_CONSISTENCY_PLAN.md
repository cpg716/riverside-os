...
| POS (`pos/*`, rails) | **Done** * | Nexo/Cart/WeddingLookup/VariantSelection/ProductIntelligence/Helcim sim/SmartButton + settings Counterpoint pill; **`text-[7px]` / `text-[8px]`** removed repo-wide under `client/src/**/*.{tsx,jsx}`. Intentional **`bg-white/alpha`** on dark POS heroes (e.g. receipt summary) kept. |
