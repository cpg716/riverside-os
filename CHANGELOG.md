...
- **Pick Up Later Fulfillment**: Register can reserve an exact, available in-stock variation for a linked Customer without sending it through procurement or receiving. The line creates a Ready-for-Pickup Fulfillment Order, reduces available stock while preserving on-hand stock, completes through the normal audited pickup path, and releases the reservation on cancellation.
