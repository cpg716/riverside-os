...
/**
 * Tax Exempt & Helcim Branding E2E Spec.
 * 
 * Goal:
 * - Verify that integrated payment methods follow the Helcim card-provider standard.
...
test.describe("Tax Exempt and Helcim Branding", () => {
  test("checkout drawer uses Helcim card flow and supports audited tax exemption", async ({
    page,
  }) => {
    ...
    // 4. Verify linking a customer keeps the Helcim card tenders available
