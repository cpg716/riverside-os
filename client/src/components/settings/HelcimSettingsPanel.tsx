    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <section className="ui-card ui-tint-neutral overflow-hidden">
        <div className="border-b border-app-border bg-app-surface-2 px-6 py-4">
          ...
          {providerSettings && (
            <div className="mt-3 grid gap-2 text-xs font-semibold text-app-text-muted md:grid-cols-1">
              ...
              {data?.transactions.length === 0 ? (
                ...
                data?.transactions.map((tx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <span className="inline-flex p-2 text-app-text-muted opacity-0 group-hover:opacity-100">
