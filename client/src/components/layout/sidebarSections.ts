...
export const SIDEBAR_SUB_SECTIONS: Record<SidebarTabId, SubItem[]> = {
  ...
  settings: [
    ...
    { id: "settings-group-store-setup", label: "Store & Staff", kind: "group" },
    { id: "profile", label: "Profile" },
    { id: "staff-access-defaults", label: "Staff Access Defaults" },
    { id: "online-store", label: "Online Store" },
    { id: "reviews", label: "Customer Reviews" },
    { id: "settings-group-register-setup", label: "Register & Printing", kind: "group" },
    ...
    { id: "station-network", label: "Station & Network" },
    { id: "settings-group-maintenance", label: "Data & Maintenance", kind: "group" },
    { id: "backups", label: "Data & Backups" },
    { id: "daily-financial-report", label: "Daily Financial Report" },
    { id: "settings-group-integrations", label: "Connected Services", kind: "group" },
    ...
    { id: "settings-group-system-support", label: "Help & System", kind: "group" },
    { id: "remote-access", label: "Remote Access" },
    { id: "help-center", label: "Help Center" },
    { id: "rosie", label: "ROSIE" },
    { id: "ros-operations-center", label: "ROS Operations & Support Center" },
