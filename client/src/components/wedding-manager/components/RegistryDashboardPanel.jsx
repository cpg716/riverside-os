...
import RegistryDashboardCard from './RegistryDashboardCard';
import { api } from '../lib/api';
import { useModal } from '../hooks/useModal';

const RegistryDashboardPanel = ({ onMemberClick, filters, onViewOrders }) => {
...
export default RegistryDashboardPanel;
