...
export const STAFF_PERMISSION_CATALOG: {
  ...
  { key: "orders.cancel", label: "Cancel transactions (including refund queue)", group: "Transactions" },
  {
    key: "orders.void_sale",
    label: "Void unpaid transactions (no payment allocations)",
    group: "Transactions",
  },
  {
    key: "orders.suit_component_swap",
    label: "Suit / component SKU swap on transaction lines (inventory-aware)",
    group: "Transactions",
  },
  { key: "orders.refund_process", label: "Process refunds & view refund queue", group: "Transactions" },
