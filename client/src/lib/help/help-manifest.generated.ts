...
import manual_14_raw from "../../assets/docs/inventory-bulk-bar-manual.md?raw";
import manual_15_raw from "../../assets/docs/inventory-control-board-manual.md?raw";
import manual_16_raw from "../../assets/docs/inventory-workspace-manual.md?raw";
import manual_17_raw from "../../assets/docs/inventory-physical-inventory-workspace-manual.md?raw";
import manual_18_raw from "../../assets/docs/inventory-product-hub-drawer-manual.md?raw";
import manual_19_raw from "../../assets/docs/inventory-product-master-form-manual.md?raw";
import manual_20_raw from "../../assets/docs/inventory-purchase-order-panel-manual.md?raw";
import manual_21_raw from "../../assets/docs/inventory-receiving-bay-manual.md?raw";
import manual_22_raw from "../../assets/docs/inventory-universal-importer-manual.md?raw";
import manual_23_raw from "../../assets/docs/inventory-vendor-hub-manual.md?raw";
import manual_24_raw from "../../assets/docs/layout-backoffice-sign-in-gate-manual.md?raw";
import manual_25_raw from "../../assets/docs/inventory-variations-workspace-manual.md?raw";
import manual_26_raw from "../../assets/docs/layout-pos-shell-manual.md?raw";
import manual_27_raw from "../../assets/docs/layout-pwa-update-prompt-manual.md?raw";
import manual_28_raw from "../../assets/docs/loyalty-workspace-manual.md?raw";
import manual_29_raw from "../../assets/docs/loyalty-redeem-dialog-manual.md?raw";
import manual_30_raw from "../../assets/docs/notifications-notification-center-bell-manual.md?raw";
import manual_31_raw from "../../assets/docs/notifications-notification-center-drawer-manual.md?raw";
import manual_32_raw from "../../assets/docs/operations-operational-home-manual.md?raw";
import manual_33_raw from "../../assets/docs/orders-workspace-manual.md?raw";
import manual_34_raw from "../../assets/docs/pos-close-register-modal-manual.md?raw";
import manual_35_raw from "../../assets/docs/operations-fulfillment-command-center-manual.md?raw";
import manual_36_raw from "../../assets/docs/pos-custom-work-manual.md?raw";
import manual_37_raw from "../../assets/docs/pos-nexo-checkout-drawer-manual.md?raw";
import manual_38_raw from "../../assets/docs/pos-shipping-manual.md?raw";
import manual_39_raw from "../../assets/docs/pos-shipping-modal-manual.md?raw";
import manual_40_raw from "../../assets/docs/pos-sidebar-manual.md?raw";
import manual_41_raw from "../../assets/docs/pos-procurement-hub-manual.md?raw";
import manual_42_raw from "../../assets/docs/pos-receipt-summary-modal-manual.md?raw";
import manual_43_raw from "../../assets/docs/pos-order-load-modal-manual.md?raw";
import manual_44_raw from "../../assets/docs/pos-register-dashboard-manual.md?raw";
import manual_45_raw from "../../assets/docs/pos-register-gift-card-load-modal-manual.md?raw";
import manual_46_raw from "../../assets/docs/pos-register-overlay-manual.md?raw";
