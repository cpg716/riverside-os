...
import manual_13_raw from "../../assets/docs/inventory-control-board-manual.md?raw";
import manual_14_raw from "../../assets/docs/inventory-workspace-manual.md?raw";
import manual_15_raw from "../../assets/docs/inventory-physical-inventory-workspace-manual.md?raw";
import manual_16_raw from "../../assets/docs/inventory-product-master-form-manual.md?raw";
import manual_17_raw from "../../assets/docs/inventory-purchase-order-panel-manual.md?raw";
import manual_18_raw from "../../assets/docs/inventory-receiving-bay-manual.md?raw";
import manual_19_raw from "../../assets/docs/inventory-universal-importer-manual.md?raw";
import manual_20_raw from "../../assets/docs/inventory-vendor-hub-manual.md?raw";
import manual_21_raw from "../../assets/docs/layout-backoffice-sign-in-gate-manual.md?raw";
import manual_22_raw from "../../assets/docs/layout-pos-shell-manual.md?raw";
