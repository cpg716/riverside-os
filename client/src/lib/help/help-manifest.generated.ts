...
import manual_0_raw from "../../assets/docs/getting-started-manual.md?raw";
import manual_1_raw from "../../assets/docs/pos-manual.md?raw";
import manual_2_raw from "../../assets/docs/reports-manual.md?raw";
import manual_3_raw from "../../assets/docs/insights-manual.md?raw";
import manual_4_raw from "../../assets/docs/wedding-manager-manual.md?raw";
import manual_5_raw from "../../assets/docs/lockout-manual.md?raw";
import manual_6_raw from "../../assets/docs/remote-access-manual.md?raw";
import manual_7_raw from "../../assets/docs/payments-workspace-manual.md?raw";
import manual_8_raw from "../../assets/docs/online-store-workspace-manual.md?raw";
import manual_9_raw from "../../assets/docs/settings-help-center-settings-panel-manual.md?raw";
import manual_10_raw from "../../assets/docs/settings-backups-manual.md?raw";
import manual_11_raw from "../../assets/docs/alterations-workspace-manual.md?raw";
import manual_12_raw from "../../assets/docs/bug-report-flow-manual.md?raw";
import manual_13_raw from "../../assets/docs/customers-customer-relationship-hub-drawer-manual.md?raw";
import manual_14_raw from "../../assets/docs/customers-workspace-manual.md?raw";
...
import manual_20_raw from "../../assets/docs/inventory-bulk-bar-manual.md?raw";
import manual_21_raw from "../../assets/docs/inventory-control-board-manual.md?raw";
import manual_22_raw from "../../assets/docs/inventory-workspace-manual.md?raw";
import manual_23_raw from "../../assets/docs/inventory-physical-inventory-workspace-manual.md?raw";
import manual_24_raw from "../../assets/docs/inventory-product-hub-drawer-manual.md?raw";
import manual_25_raw from "../../assets/docs/inventory-product-master-form-manual.md?raw";
import manual_26_raw from "../../assets/docs/inventory-purchase-order-panel-manual.md?raw";
import manual_27_raw from "../../assets/docs/inventory-receiving-bay-manual.md?raw";
import manual_28_raw from "../../assets/docs/inventory-universal-importer-manual.md?raw";
import manual_29_raw from "../../assets/docs/inventory-vendor-hub-manual.md?raw";
import manual_30_raw from "../../assets/docs/layout-backoffice-sign-in-gate-manual.md?raw";
import manual_31_raw from "../../assets/docs/inventory-variations-workspace-manual.md?raw";
import manual_32_raw from "../../assets/docs/layout-pos-shell-manual.md?raw";
import manual_33_raw from "../../assets/docs/layout-pwa-update-prompt-manual.md?raw";
import manual_34_raw from "../../assets/docs/loyalty-workspace-manual.md?raw";
import manual_35_raw from "../../assets/docs/loyalty-redeem-dialog-manual.md?raw";
import manual_36_raw from "../../assets/docs/notifications-notification-center-bell-manual.md?raw";
import manual_37_raw from "../../assets/docs/notifications-notification-center-drawer-manual.md?raw";
import manual_38_raw from "../../assets/docs/operations-operational-home-manual.md?raw";
import manual_39_raw from "../../assets/docs/orders-workspace-manual.md?raw";
import manual_40_raw from "../../assets/docs/pos-close-register-modal-manual.md?raw";
import manual_41_raw from "../../assets/docs/pilot-recovery-governance-manual.md?raw";
import manual_42_raw from "../../assets/docs/operations-fulfillment-command-center-manual.md?raw";
import manual_43_raw from "../../assets/docs/pos-custom-work-manual.md?raw";
import manual_44_raw from "../../assets/docs/pos-nexo-checkout-drawer-manual.md?raw";
import manual_45_raw from "../../assets/docs/pos-shipping-manual.md?raw";
import manual_46_raw from "../../assets/docs/pos-shipping-modal-manual.md?raw";
import manual_47_raw from "../../assets/docs/pos-sidebar-manual.md?raw";
import manual_48_raw from "../../assets/docs/pos-procurement-hub-manual.md?raw";
import manual_49_raw from "../../assets/docs/pos-receipt-summary-modal-manual.md?raw";
import manual_50_raw from "../../assets/docs/pos-order-load-modal-manual.md?raw";
import manual_51_raw from "../../assets/docs/pos-register-dashboard-manual.md?raw";
import manual_52_raw from "../../assets/docs/pos-register-gift-card-load-modal-manual.md?raw";
import manual_53_raw from "../../assets/docs/pos-register-overlay-manual.md?raw";
import manual_54_raw from "../../assets/docs/pos-register-reports-manual.md?raw";
import manual_55_raw from "../../assets/docs/qbo-mapping-matrix-manual.md?raw";
import manual_56_raw from "../../assets/docs/qbo-workspace-manual.md?raw";
import manual_57_raw from "../../assets/docs/reports-workspace-manual.md?raw";
import manual_58_raw from "../../assets/docs/scheduler-workspace-manual.md?raw";
import manual_59_raw from "../../assets/docs/settings-bug-reports-settings-panel-manual.md?raw";
import manual_60_raw from "../../assets/docs/settings-counterpoint-sync-settings-panel-manual.md?raw";
import manual_61_raw from "../../assets/docs/settings-helcim-settings-panel-manual.md?raw";
import manual_62_raw from "../../assets/docs/settings-meilisearch-settings-panel-manual.md?raw";
import manual_63_raw from "../../assets/docs/settings-receipt-builder-panel-manual.md?raw";
import manual_64_raw from "../../assets/docs/settings-remote-access-panel-manual.md?raw";
import manual_65_raw from "../../assets/docs/staff-commission-payouts-panel-manual.md?raw";
import manual_66_raw from "../../assets/docs/staff-schedule-panel-manual.md?raw";
import manual_67_raw from "../../assets/docs/settings-printers-and-scanners-panel-manual.md?raw";
import manual_68_raw from "../../assets/docs/staff-commission-manager-workspace-manual.md?raw";
...
export const HELP_MANUALS: HelpManual[] = [
  {
    ...
    summary: "Sign in, understand Back Office and Register, find your work, use Help and ROSIE, and finish tasks safely.",
    markdown: manual_0_raw,
    tags: ["getting-started","training","sign-in","navigation","help","rosie"],
  },
  {
    id: "pos",
    title: "Register (POS)",
