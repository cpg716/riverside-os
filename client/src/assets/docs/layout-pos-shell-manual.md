...
3. If the till is not open yet, the shell will route you into the register access flow before sales work can continue.
4. Use **Exit POS** only when you need to return to the broader Back Office shell.
