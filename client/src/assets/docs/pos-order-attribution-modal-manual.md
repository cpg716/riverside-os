...
order: 1057
summary: "Draft maintainer scaffold for client/src/components/pos/OrderAttributionModal.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/pos/OrderAttributionModal.tsx
last_scanned: 2026-04-27
tags: pos-order-attribution-modal, component, auto-scaffold
status: draft
---

# Order Attribution Modal (pos)

<!-- help:component-source -->
_Linked component: `client/src/components/pos/OrderAttributionModal.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/pos-order-attribution-modal/` and replace this example with governed screenshots.

![Example](../images/help/pos-order-attribution-modal/example.png)
