...
Every standard sale receipt includes every purchased transaction line. Mixed transactions group merchandise under every applicable section—**Taken Today**, **Pick Up Later**, **Special Order**, **Custom Order**, **Wedding Order**, or **Layaway**—and a line's fulfillment type never removes it from the receipt.
