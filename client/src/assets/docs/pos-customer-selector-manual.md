...
order: 1053
summary: "Draft maintainer scaffold for client/src/components/pos/CustomerSelector.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/pos/CustomerSelector.tsx
last_scanned: 2026-04-27
tags: pos-customer-selector, component, auto-scaffold
status: draft
---

# Customer Selector (pos)

<!-- help:component-source -->
_Linked component: `client/src/components/pos/CustomerSelector.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/pos-customer-selector/` and replace this example with governed screenshots.

![Example](../images/help/pos-customer-selector/example.png)
