---
id: ui-address-autocomplete-input
title: "Address Autocomplete Input (ui)"
order: 1141
summary: "Draft maintainer scaffold for client/src/components/ui/AddressAutocompleteInput.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/ui/AddressAutocompleteInput.tsx
last_scanned: 2026-04-27
tags: ui-address-autocomplete-input, component, auto-scaffold
status: draft
---

# Address Autocomplete Input (ui)

<!-- help:component-source -->
_Linked component: `client/src/components/ui/AddressAutocompleteInput.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/ui-address-autocomplete-input/` and replace this example with governed screenshots.

![Example](../images/help/ui-address-autocomplete-input/example.png)
