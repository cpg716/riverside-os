...
order: 1035
summary: "Draft maintainer scaffold for client/src/components/layout/RegisterPickModal.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/layout/RegisterPickModal.tsx
last_scanned: 2026-04-27
tags: layout-register-pick-modal, component, auto-scaffold
status: draft
---

# Register Pick Modal (layout)

<!-- help:component-source -->
_Linked component: `client/src/components/layout/RegisterPickModal.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/layout-register-pick-modal/` and replace this example with governed screenshots.

![Example](../images/help/layout-register-pick-modal/example.png)
