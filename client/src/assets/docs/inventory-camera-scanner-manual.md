...
order: 1012
summary: "Draft maintainer scaffold for client/src/components/inventory/CameraScanner.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/inventory/CameraScanner.tsx
last_scanned: 2026-04-23
tags: inventory-camera-scanner, component, auto-scaffold
status: draft
---

# Camera Scanner (inventory)

<!-- help:component-source -->
_Linked component: `client/src/components/inventory/CameraScanner.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/inventory-camera-scanner/` and replace this example with governed screenshots.

![Example](../images/help/inventory-camera-scanner/example.png)
