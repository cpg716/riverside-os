...
# Register Settings (pos)

<!-- help:component-source -->
_Linked component: `client/src/components/pos/RegisterSettings.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/pos-register-settings/` and replace this example with governed screenshots.

![Example](../images/help/pos-register-settings/example.png)
