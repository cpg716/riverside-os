...
11. Enter a destination under **Delivery tests** and use **Send Test Email** or **Send Test Text** to send the current preview without saving first. Email uses Store Email and embeds a PNG of the receipt so Outlook-compatible clients display the actual preview; text sends the same receipt image through Podium.
