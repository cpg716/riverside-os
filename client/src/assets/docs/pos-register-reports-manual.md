...
The Z-Report tender section includes Cash, Credit Card, and Checks for each Register. Deposit reconciliation shows **Cash Deposit**, **Checks for Deposit**, and **Total Deposit**, where Total Deposit is the cash and check amount being taken to the bank.
