...
- **Service charges**: Shipping fees and alteration-service charges appear on their original Transaction card, in separate service totals, printed reports, and CSV exports. They do not increase **Daily Sales**, **Sales Total**, **Net Sales**, or the sales-count/average metrics. Payments collected for them remain in tender reconciliation.
