...
# Help Center Settings Panel (settings)

<!-- help:component-source -->
_Linked component: `client/src/components/settings/HelpCenterSettingsPanel.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/settings-help-center-settings-panel/` and replace this example with governed screenshots.

![Example](../images/help/settings-help-center-settings-panel/example.png)
