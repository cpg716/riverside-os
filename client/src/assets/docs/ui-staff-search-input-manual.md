...
order: 1129
summary: "Draft maintainer scaffold for client/src/components/ui/StaffSearchInput.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/ui/StaffSearchInput.tsx
last_scanned: 2026-04-27
tags: ui-staff-search-input, component, auto-scaffold
status: draft
---

# Staff Search Input (ui)

<!-- help:component-source -->
_Linked component: `client/src/components/ui/StaffSearchInput.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/ui-staff-search-input/` and replace this example with governed screenshots.

![Example](../images/help/ui-staff-search-input/example.png)
