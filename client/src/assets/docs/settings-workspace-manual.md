...
order: 1100
summary: "Draft maintainer scaffold for client/src/components/settings/SettingsWorkspace.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/settings/SettingsWorkspace.tsx
...
_Linked component: `client/src/components/settings/SettingsWorkspace.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/settings-workspace/` and replace this example with governed screenshots.

![Example](../images/help/settings-workspace/example.png)
