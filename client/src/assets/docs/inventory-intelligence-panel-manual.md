...
order: 1017
summary: "Draft maintainer scaffold for client/src/components/inventory/IntelligencePanel.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/inventory/IntelligencePanel.tsx
last_scanned: 2026-04-27
tags: inventory-intelligence-panel, component, auto-scaffold
status: draft
---

# Intelligence Panel (inventory)

<!-- help:component-source -->
_Linked component: `client/src/components/inventory/IntelligencePanel.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/inventory-intelligence-panel/` and replace this example with governed screenshots.

![Example](../images/help/inventory-intelligence-panel/example.png)
