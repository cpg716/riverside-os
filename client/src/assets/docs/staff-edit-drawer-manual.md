...
order: 1124
summary: "Draft maintainer scaffold for client/src/components/staff/StaffEditDrawer.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/staff/StaffEditDrawer.tsx
last_scanned: 2026-04-27
tags: staff-edit-drawer, component, auto-scaffold
status: draft
---

# Staff Edit Drawer (staff)

<!-- help:component-source -->
_Linked component: `client/src/components/staff/StaffEditDrawer.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/staff-edit-drawer/` and replace this example with governed screenshots.

![Example](../images/help/staff-edit-drawer/example.png)
