...
1. Identify the workflow that is blocked: Register, close register, QBO, RMS Charge, receiving, physical inventory, customer merge, printer, or offline recovery.
...
|-------------|------------|-----------------|
| **blocked checkout** or **split tender** | [Register Checkout](manual:pos-nexo-checkout-drawer) | Verify balance due, tender state, and any manager prompt before retrying Complete Sale. |
...
| **wedding pickup** or fulfillment question | [Orders Workspace](manual:orders-workspace) | Confirm transaction, balance, line readiness, and fulfillment status before marking pickup complete. |
...
- A failed final post, payment, refund, or QBO sync may already have partial evidence. Check the source record before retrying.
