...
order: 1122
summary: "Draft maintainer scaffold for client/src/components/ui/VariantSearchInput.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/ui/VariantSearchInput.tsx
last_scanned: 2026-04-27
tags: ui-variant-search-input, component, auto-scaffold
status: draft
---

# Variant Search Input (ui)

<!-- help:component-source -->
_Linked component: `client/src/components/ui/VariantSearchInput.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/ui-variant-search-input/` and replace this example with governed screenshots.

![Example](../images/help/ui-variant-search-input/example.png)
