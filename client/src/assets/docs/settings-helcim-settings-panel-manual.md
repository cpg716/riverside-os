...
- Manual Card and public web checkout use HelcimPay.js. Add the public HTTPS ROS/PWA checkout origin, and any desktop app WebView origin shown by Riverside, to the Helcim API Access Configuration before live keyed entry. Localhost is not valid for live manual-card entry.
