...
Add PNGs under `../images/help/orders-transaction-detail-drawer/` and replace this example with governed screenshots.

![Example](../images/help/orders-transaction-detail-drawer/example.png)
