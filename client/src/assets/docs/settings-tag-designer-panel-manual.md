---
id: settings-tag-designer-panel
title: "Tag Designer Panel (settings)"
order: 1121
...
# Tag Designer Panel (settings)

<!-- help:component-source -->
_Linked component: `client/src/components/settings/TagDesignerPanel.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/settings-tag-designer-panel/` and replace this example with governed screenshots.

![Example](../images/help/settings-tag-designer-panel/example.png)
