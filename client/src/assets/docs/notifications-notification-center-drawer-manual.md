...
order: 1045
summary: "Draft maintainer scaffold for client/src/components/notifications/NotificationCenterDrawer.tsx. Promote to approved after SOP review and screenshot capture."
...
# Notification Center Drawer (notifications)
...
Add PNGs under `../images/help/notifications-notification-center-drawer/` and replace this example with governed screenshots.

![Example](../images/help/notifications-notification-center-drawer/example.png)
