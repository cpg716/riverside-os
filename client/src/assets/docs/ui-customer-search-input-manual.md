...
# Customer Search Input (ui)

<!-- help:component-source -->
_Linked component: `client/src/components/ui/CustomerSearchInput.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/ui-customer-search-input/` and replace this example with governed screenshots.

![Example](../images/help/ui-customer-search-input/example.png)
