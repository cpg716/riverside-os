...
order: 1041
summary: "Draft maintainer scaffold for client/src/components/layout/WeddingShell.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/layout/WeddingShell.tsx
last_scanned: 2026-04-27
tags: layout-wedding-shell, component, auto-scaffold
status: draft
---

# Wedding Shell (layout)

<!-- help:component-source -->
_Linked component: `client/src/components/layout/WeddingShell.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/layout-wedding-shell/` and replace this example with governed screenshots.

![Example](../images/help/layout-wedding-shell/example.png)
