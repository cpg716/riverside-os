...
order: 1078
summary: "Draft maintainer scaffold for client/src/components/pos/StripeReaderSimulation.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/pos/StripeReaderSimulation.tsx
last_scanned: 2026-04-27
tags: pos-stripe-reader-simulation, component, auto-scaffold
status: draft
---

# Stripe Reader Simulation (pos)

<!-- help:component-source -->
_Linked component: `client/src/components/pos/StripeReaderSimulation.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/pos-stripe-reader-simulation/` and replace this example with governed screenshots.

![Example](../images/help/pos-stripe-reader-simulation/example.png)
