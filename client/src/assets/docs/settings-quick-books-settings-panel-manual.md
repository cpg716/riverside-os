...
# Quick Books Settings Panel (settings)

<!-- help:component-source -->
_Linked component: `client/src/components/settings/QuickBooksSettingsPanel.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/settings-quick-books-settings-panel/` and replace this example with governed screenshots.

![Example](../images/help/settings-quick-books-settings-panel/example.png)
