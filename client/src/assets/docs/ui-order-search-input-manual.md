...
order: 1125
summary: "Draft maintainer scaffold for client/src/components/ui/OrderSearchInput.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/ui/OrderSearchInput.tsx
last_scanned: 2026-04-23
tags: ui-order-search-input, component, auto-scaffold
status: draft
---

# Order Search Input (ui)

<!-- help:component-source -->
_Linked component: `client/src/components/ui/OrderSearchInput.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/ui-order-search-input/` and replace this example with governed screenshots.

![Example](../images/help/ui-order-search-input/example.png)
