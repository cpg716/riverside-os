...
order: 1121
summary: "Draft maintainer scaffold for client/src/components/ui/ToastProvider.tsx. Promote to approved after SOP review and screenshot capture."
...
_Linked component: `client/src/components/ui/ToastProvider.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/ui-toast-provider/` and replace this example with governed screenshots.

![Example](../images/help/ui-toast-provider/example.png)
