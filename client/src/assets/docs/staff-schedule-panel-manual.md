...
order: 1108
summary: "Draft maintainer scaffold for client/src/components/staff/StaffSchedulePanel.tsx. Promote to approved after SOP review and screenshot capture."
...
# Staff Schedule Panel (staff)

<!-- help:component-source -->
_Linked component: `client/src/components/staff/StaffSchedulePanel.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/staff-schedule-panel/` and replace this example with governed screenshots.

![Example](../images/help/staff-schedule-panel/example.png)
