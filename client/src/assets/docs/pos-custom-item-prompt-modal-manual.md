...
order: 1054
summary: "Draft maintainer scaffold for client/src/components/pos/CustomItemPromptModal.tsx. Promote to approved after SOP review and screenshot capture."
source: client/src/components/pos/CustomItemPromptModal.tsx
last_scanned: 2026-04-27
tags: pos-custom-item-prompt-modal, component, auto-scaffold
status: draft
---

# Custom Item Prompt Modal (pos)

<!-- help:component-source -->
_Linked component: `client/src/components/pos/CustomItemPromptModal.tsx`._
<!-- /help:component-source -->
...
Add PNGs under `../images/help/pos-custom-item-prompt-modal/` and replace this example with governed screenshots.

![Example](../images/help/pos-custom-item-prompt-modal/example.png)
