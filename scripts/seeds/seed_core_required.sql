...
-- Protected system salesperson for no-commission sales attribution.
...
-- Custom Orders: operational category for made-to-measure / custom garment lines
INSERT INTO public.categories (id, name, is_clothing_footwear, parent_id, created_at, matrix_row_axis_key, matrix_col_axis_key, tax_rules, variation_axis_presets) VALUES ('b7c0a010-0010-4010-8010-000000000010', 'Custom Orders', true, NULL, '2026-05-05 00:16:00.000000+00', NULL, NULL, NULL, '{}') ON CONFLICT DO NOTHING;
...
-- Custom Orders commission mirrors store default (not zeroed out — custom garments earn commission)
-- No override row inserted; the store-level commission rate applies.
...
INSERT INTO public.ledger_mappings (id, internal_key, internal_description, qbo_account_id, updated_at) VALUES ('3d080eb0-8032-4e42-96db-c933ff8f36ea', 'RMS_CHARGE_FINANCING_CLEARING', 'Unified RMS Charge financed purchase clearing account for recorded RMS/R2S follow-up.', NULL, '2026-05-05 00:16:17.408258+00') ON CONFLICT DO NOTHING;
...
-- Custom Orders operational SKUs (SKUs match CUSTOM_ORDER_SUBTYPES in client/src/lib/customOrders.ts)
-- primary_vendor_id is NULL — assign once HSM / Individualized Shirts vendors are loaded
INSERT INTO public.products (id, category_id, catalog_handle, name, brand, description, base_retail_price, base_cost, spiff_amount, variation_axes, images, is_active, created_at, primary_vendor_id, excludes_from_loyalty, is_bundle, track_low_stock, pos_line_kind, data_source, tax_category, employee_markup_percent, employee_extra_amount, nuorder_last_image_sync_at, tax_category_override) VALUES ('b7c0a011-0011-4011-8011-000000000011', 'b7c0a010-0010-4010-8010-000000000010', 'ros-custom-hsm-suit', 'HSM SUIT (Custom)', 'Hart Schaffner Marx', 'Hart Schaffner & Marx made-to-measure suit. Price set at booking via Register custom order form.', 0.00, 0.00, 0.00, '{}', '{}', true, '2026-05-05 00:16:00.000000+00', NULL, false, false, false, NULL, NULL, 'clothing', NULL, 0.00, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.products (id, category_id, catalog_handle, name, brand, description, base_retail_price, base_cost, spiff_amount, variation_axes, images, is_active, created_at, primary_vendor_id, excludes_from_loyalty, is_bundle, track_low_stock, pos_line_kind, data_source, tax_category, employee_markup_percent, employee_extra_amount, nuorder_last_image_sync_at, tax_category_override) VALUES ('b7c0a012-0012-4012-8012-000000000012', 'b7c0a010-0010-4010-8010-000000000010', 'ros-custom-hsm-sport-coat', 'HSM SPORT COAT (Custom)', 'Hart Schaffner Marx', 'Hart Schaffner & Marx made-to-measure sport coat. Price set at booking via Register custom order form.', 0.00, 0.00, 0.00, '{}', '{}', true, '2026-05-05 00:16:00.000000+00', NULL, false, false, false, NULL, NULL, 'clothing', NULL, 0.00, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.products (id, category_id, catalog_handle, name, brand, description, base_retail_price, base_cost, spiff_amount, variation_axes, images, is_active, created_at, primary_vendor_id, excludes_from_loyalty, is_bundle, track_low_stock, pos_line_kind, data_source, tax_category, employee_markup_percent, employee_extra_amount, nuorder_last_image_sync_at, tax_category_override) VALUES ('b7c0a013-0013-4013-8013-000000000013', 'b7c0a010-0010-4010-8010-000000000010', 'ros-custom-hsm-slacks', 'HSM SLACKS (Custom)', 'Hart Schaffner Marx', 'Hart Schaffner & Marx made-to-measure slacks. Price set at booking via Register custom order form.', 0.00, 0.00, 0.00, '{}', '{}', true, '2026-05-05 00:16:00.000000+00', NULL, false, false, false, NULL, NULL, 'clothing', NULL, 0.00, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.products (id, category_id, catalog_handle, name, brand, description, base_retail_price, base_cost, spiff_amount, variation_axes, images, is_active, created_at, primary_vendor_id, excludes_from_loyalty, is_bundle, track_low_stock, pos_line_kind, data_source, tax_category, employee_markup_percent, employee_extra_amount, nuorder_last_image_sync_at, tax_category_override) VALUES ('b7c0a014-0014-4014-8014-000000000014', 'b7c0a010-0010-4010-8010-000000000010', 'ros-custom-individualized-shirt', 'INDIVIDUALIZED SHIRT (Custom)', 'Individualized Shirts', 'Individualized Shirts made-to-measure dress shirt. Price set at booking via Register custom order form.', 0.00, 0.00, 0.00, '{}', '{}', true, '2026-05-05 00:16:00.000000+00', NULL, false, false, false, NULL, NULL, 'clothing', NULL, 0.00, NULL, NULL) ON CONFLICT DO NOTHING;
...
-- Custom Orders operational variants — SKUs must match CUSTOM_ORDER_SUBTYPES in client/src/lib/customOrders.ts
INSERT INTO public.product_variants (id, product_id, sku, variation_values, variation_label, stock_on_hand, reorder_point, images, retail_price_override, cost_override, created_at, shelf_labeled_at, barcode, reserved_stock, vendor_upc, counterpoint_item_key, track_low_stock, web_published, web_price_override, web_gallery_order, counterpoint_prc_2, counterpoint_prc_3, nuorder_id, on_layaway, default_location_id) VALUES ('b7c0a015-0015-4015-8015-000000000015', 'b7c0a011-0011-4011-8011-000000000011', '100', '{}', NULL, 0, 0, '{}', NULL, NULL, '2026-05-05 00:16:00.000000+00', NULL, NULL, 0, NULL, NULL, false, false, NULL, 0, NULL, NULL, NULL, 0, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.product_variants (id, product_id, sku, variation_values, variation_label, stock_on_hand, reorder_point, images, retail_price_override, cost_override, created_at, shelf_labeled_at, barcode, reserved_stock, vendor_upc, counterpoint_item_key, track_low_stock, web_published, web_price_override, web_gallery_order, counterpoint_prc_2, counterpoint_prc_3, nuorder_id, on_layaway, default_location_id) VALUES ('b7c0a016-0016-4016-8016-000000000016', 'b7c0a012-0012-4012-8012-000000000012', '105', '{}', NULL, 0, 0, '{}', NULL, NULL, '2026-05-05 00:16:00.000000+00', NULL, NULL, 0, NULL, NULL, false, false, NULL, 0, NULL, NULL, NULL, 0, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.product_variants (id, product_id, sku, variation_values, variation_label, stock_on_hand, reorder_point, images, retail_price_override, cost_override, created_at, shelf_labeled_at, barcode, reserved_stock, vendor_upc, counterpoint_item_key, track_low_stock, web_published, web_price_override, web_gallery_order, counterpoint_prc_2, counterpoint_prc_3, nuorder_id, on_layaway, default_location_id) VALUES ('b7c0a017-0017-4017-8017-000000000017', 'b7c0a013-0013-4013-8013-000000000013', '110', '{}', NULL, 0, 0, '{}', NULL, NULL, '2026-05-05 00:16:00.000000+00', NULL, NULL, 0, NULL, NULL, false, false, NULL, 0, NULL, NULL, NULL, 0, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.product_variants (id, product_id, sku, variation_values, variation_label, stock_on_hand, reorder_point, images, retail_price_override, cost_override, created_at, shelf_labeled_at, barcode, reserved_stock, vendor_upc, counterpoint_item_key, track_low_stock, web_published, web_price_override, web_gallery_order, counterpoint_prc_2, counterpoint_prc_3, nuorder_id, on_layaway, default_location_id) VALUES ('b7c0a018-0018-4018-8018-000000000018', 'b7c0a014-0014-4014-8014-000000000014', '200', '{}', NULL, 0, 0, '{}', NULL, NULL, '2026-05-05 00:16:00.000000+00', NULL, NULL, 0, NULL, NULL, false, false, NULL, 0, NULL, NULL, NULL, 0, NULL) ON CONFLICT DO NOTHING;
