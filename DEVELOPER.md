...
| `migrations/` | Schema and incremental DDL (numbered `NN_*.sql`; current files **00–117** — see [Migrations reference](#migrations-reference-selected-files-see-migrations-for-full-set)). |
